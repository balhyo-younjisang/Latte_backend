...
public interface UserController {
     ...
     * 
     * @param createUserReqDto email, password, name, intro 를 Request Body에서 매칭하는
     *                         DTO
     ...
     * 
     * @param loginUserReqDto loginUserReqDto email, password를 Request Body에서 DTO로
     *                        매칭
     * @return 토큰 반환
     * @throws Exception UserNotFoundException
     */
    @PostMapping("/login")
    public Response<Boolean> loginUser(HttpServletRequest httpServletRequest,
            @Valid UserDto.LoginUserReqDto loginUserReqDto) throws Exception;
    ...
    public Response<UserDto.UpdateUserResDto> updateUser(
            @SessionAttribute(name = "userId", required = true) Long userId,
            @Valid UserDto.UpdateUserReqDto updateUserIntroReqDto) throws Exception;
